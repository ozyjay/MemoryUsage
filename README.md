...
A small GNOME Shell extension for Fedora Workstation that shows RAM plus the
Fedora and Work SSD usage in the top bar, and adds a dropdown with RAM, swap,
and SSD details.
